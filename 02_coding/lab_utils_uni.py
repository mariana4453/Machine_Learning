...
def plt_gradients(x_train, y_train, f_compute_cost, f_compute_gradient, w, b):
    #===============
    #  First subplot
    #===============
    ...
    for i in range(len(w_array)):
        tmp_w = w_array[i]
        cost[i] = f_compute_cost(x_train, y_train, tmp_w, b)
    ax[0].plot(w_array, cost,linewidth=1)
    ax[0].set_title("Cost vs w, with gradient; b set to {}".format(b))
